...
def Augmentation (diff_dataset, batch=20):
    ...
    # Balancing of the workable dataset
    Patches = []
    Annotation = []
    
    for i, image in enumerate(diff_dataset):
        
        # For each image, concatenation of the mass patches with the same number of non mass patches
    ...
    # Building of the Data Augmentation function
    ...
    # Adding every set to a Generator
